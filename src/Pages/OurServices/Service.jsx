...
import ServiceSwiper from "../../Components/ServiceCard/ServiceSwiper";
...
const Service = () => {
  return (
    <>
      <Nav />
      <div className="relative top-0 left-0 object-cover w-full h-[100%] transition-all duration-[0.4s] ease-linear bg-[url('/Images/Services/1.jpg')] bg-no-repeat bg-center bg-cover">
        ...
        <div className="relative flex flex-col items-center justify-center text-center gap-[2rem] pt-[25rem] pb-[10rem] h-[100%]">
          ...
          <p className="text-[2rem] text-[#f2f2f2] font-normal max-w-[50%] max-md:max-w-[80%] max-[500px]:max-w-[100%] max-[500px]:px-[3rem]">
            At TWOM Global, we provide expert solutions tailored to enhance your
            business performance, drive growth, and ensure lasting success.
          </p>
        </div>
      </div>
      <ServicePart />
